...
<head>
    ...
    <style>
        ...
        .neon-card {
            ...
            box-shadow: 0 0 20px rgba(255, 102, 204, 0.5), inset 0 0 15px rgba(255, 102, 204, 0.2);
        ...
        .girl-item:hover { background: rgba(255, 102, 204, 0.3); box-shadow: 0 0 12px #ff66cc; }
        .boy-item:hover { background: rgba(0, 153, 255, 0.3); box-shadow: 0 0 12px #0099ff; }
...
<section id="about" class="text-center px-4 py-12">
    ...
    <div class="max-w-md sm:max-w-2xl mx-auto text-gray-200">
        <p>I am <span class="font-bold text-white">Jocelyn Semillano</span>, a dedicated 2nd Year BSIT Student from BSIT-2B. I specialize in web development and creating magical digital experiences.</p>
    </div>
</section>
...
<section id="simulation" class="text-center px-4 py-12">
    ...
    <div class="max-w-4xl mx-auto neon-card rounded-3xl p-6">
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-8">
            <input type="date" id="attendanceDate" class="neon-input p-2 rounded-lg outline-none">
            <input type="text" id="subjectName" placeholder="Subject Name" class="neon-input p-2 rounded-lg outline-none">
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div class="bg-pink-900/20 p-4 rounded-2xl border border-pink-500/50 shadow-[0_0_15px_rgba(255,102,204,0.3)]">
                <h4 class="text-pink-300 font-bold mb-4">Girls 🌸</h4>
                <div id="girlsList" class="space-y-2 text-left h-64 overflow-y-auto pr-2"></div>
            </div>
            <div class="bg-blue-900/20 p-4 rounded-2xl border border-blue-500/50 shadow-[0_0_15px_rgba(0,153,255,0.3)]">
                <h4 class="text-blue-300 font-bold mb-4">Boys 💎</h4>
                <div id="boysList" class="space-y-2 text-left h-64 overflow-y-auto pr-2"></div>
            </div>
        </div>

        <button onclick="generateSummary()" class="px-16 py-3 bg-pink-600 rounded-full font-bold hover:bg-pink-700 transition transform hover:scale-110 shadow-[0_0_20px_#ff66cc] border-2 border-pink-300">DONE ✨</button>
...
<div id="chat-container">
    ...
    <div id="chat-messages"><div class="bot-msg">✨ Hi there! I am Celyn's Assistant. I have all the facts about her portfolio! How can I help you today?</div></div>
...
<script>
    ...
    function botResponse(u) {
        ...
        // 🧠 High-Accuracy Logic based on code contents
        if (t.includes("hello") || t.includes("hi") || t.includes("hey")) {
            r = "Hello! ✨ I'm here to guide you through Jocelyn Semillano's (Celyn) portfolio. What would you like to know?";
        }
        else if (t.includes("who") || t.includes("about") || t.includes("jocelyn") || t.includes("celyn")) {
            r = "Jocelyn Semillano, also known as Celyn, is a 2nd Year BSIT student in section BSIT-2B. She is a talented web developer and multimedia editor! 👩‍💻";
        }
        else if (t.includes("project") || t.includes("work") || t.includes("figma") || t.includes("ecommerce")) {
            r = "Celyn's projects include a Chessboard UI, T-shirt layout, product design, and a full Figma E-commerce prototype. Check out 'My Projects' for details! 🛠️";
        }
            ...
            r = "Celyn earned IT Training Certificates on March 10 and March 12, 2026. They are located in the 'Certificates' section! 📜";
        }
        else if (t.includes("attendance") || t.includes("simulation") || t.includes("bsit-2b")) {
            r = "Celyn created a custom BSIT-2B Attendance System simulation with automated tracking for girls and boys. Try it in 'Simulation'! 🧪✨";
        }
        else if (t.includes("skill") || t.includes("tool") || t.includes("software")) {
            r = "She is skilled in Canva, Figma, Adobe Photoshop, and Adobe Premiere Pro. She's great at both design and video editing! 🪄";
        }
        else if (t.includes("experience") || t.includes("award") || t.includes("champion") || t.includes("winner")) {
            r = "Celyn was a Video Editing Champion in 2021 and a Tarpapel Editor in 2020! She has deep experience with Film Maker Pro and KineMaster. 🏆";
        }
        else if (t.includes("youtube") || t.includes("tutorial") || t.includes("video")) {
            r = "Celyn has educational tutorials on YouTube. You can watch them in the 'Tutorials' section of this portfolio! 🎥";
        }
        else if (t.includes("contact") || t.includes("email") || t.includes("message")) {
            r = "You can connect with Celyn by using the contact form at the bottom of the page! 💌";
        }
        else if (t.includes("girl") || t.includes("boy") || t.includes("student")) {
            r = "The attendance list includes students like Andrea Jean, Jessa, John Rogen, and Archie. You can see the full list in the Simulation! 🌸💎";
        }
        else {
            r = "I'm a simple bot, but I can tell you about Celyn's projects, her IT certificates from March 2026, or her BSIT-2B simulation! What's next? ✨";
        }
